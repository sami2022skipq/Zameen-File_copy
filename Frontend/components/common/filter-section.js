...
import MobileBuyFilter from "../extras/MobileBuyFilter";
import ListingFilter from "../extras/ListingFilter";
  ...
  return (
    <>
        ...
        <div className="w-full lg:w-[1110px] space-y-5 lg:space-y-7 mx-0 lg:mx-auto relative">
          ...
          <div className="relative flex flex-col items-center justify-between">
            <div className="flex gap-x-3 lg:gap-x-5 text-xs lg:text-sm px-3 lg:px-0 py-2 lg:py-0 overflow-x-auto">
              ...
              <div
                className="w-32 lg:w-28 text-center lg:text-left flex-none border-gray-400 border-[1.8px] flex items-center rounded-full lg:rounded-sm px-2 lg:px-1 justify-between cursor-pointer"
                onClick={() => setOpenModel(!openModel)}
              >
                <p className="w-full lg:w-fit">More Filters</p>
            ...
            <div className="lg:block hidden">{openModel && <ListingFilter />}</div>
          </div>
      ...
      <div className="block lg:hidden">
        <MobileBuyFilter openModel={openModel} closeModel={setOpenModel} />
      </div>
    </>
  );
};
