...
function Header() {
  return (
    <div className="w-full fixed top-0 right-0 bg-white px-10 sm:16 md:px-28 py-6 shadow-md z-20 flex items-center justify-between">
      <div className="flex items-center sm:gap-x-24">
        ...
        <div className="hidden md:flex items-center gap-x-16">
          ...
          <Link href="contact-us" className="text-sm font-semibold">
            Contact Us
          </Link>
          <h5 className="text-sm font-semibold">Agent</h5>
        </div>
      </div>
      <Link href="/sign-in" className="hidden md:flex items-center gap-x-1.5">
