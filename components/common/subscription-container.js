const SubscriptionContainer = () => {
  return (
    <div className="w-full px-5 lg:px-0 lg:w-[1080px] mx-auto pt-8 pb-16 space-y-7">
      <div className="bg-white rounded w-fit py-1 px-4">SUBSCRIBE</div>
      <div className="text-white flex flex-col lg:items-center lg:justify-between space-y-7">
